...
public class CommandeCreerOuModifier extends FenetreCreationModification {
    ...
    /**
     * Fenetre d'ajout d'article é la commande
     */
    private AjouterArticle ajouterArticle;

    /**
     * Constructeur
     * Définit la fenétre et ses composants - affiche la fenétre
     * Si commande est null, on va créer un nouvel commande, sinon on modifie celui passé en paramétre
     */
    public CommandeCreerOuModifier(Commande commande, Client[] clients, ActionListener listener) {
        ...
        //il autorisera un retaillage de la fenétre en conservant la présentation
        ...
        checkBoxUpdateDate = new JCheckBox("Mettre é jour la date de la commande");
    ...
    public void afficherListeArticles(ActionListener listener) {
        ...
        // créé tous les labels avec é chaque fois une lineBorder et un texte aligné au centre
    ...
    /**
     * Créé un JLabel avec le texte passé en paramétre avec une bordure noire et le texte aligné au centre
